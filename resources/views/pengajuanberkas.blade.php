...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            src: url('C:\Users\HP\OneDrive - Politeknik Negeri Bandung\SEMESTER_3_2C_JTK\PROYEK3\UI\gilroy-free\Gilroy-FREE') format('truetype'); /* Ganti dengan path font yang benar */
        }
        @font-face {
        ...
        input[type="file"]::-webkit-file-upload-button {
            background-color: #FF9A36; /* Warna background */
            color: white; /* Warna tulisan */
            border: none; /* Menghilangkan border */
            border-radius: 0.375rem; /* Border radius untuk sudut */
            padding: 0.5rem 1rem; /* Padding untuk tombol */
            cursor: pointer; /* Ubah kursor saat hover */
            font-family: 'Gilroy Light', sans-serif; /* Menggunakan font Gilroy Light untuk tombol */
        }

        input[type="file"] {
            display: block; /* Menampilkan input file sebagai block */
            width: 100%; /* Membuat input file memenuhi lebar kolom */
            border: 2px dashed #FF9A36; /* Garis putus-putus dengan warna yang sama */
            border-radius: 0.375rem; /* Border radius untuk sudut */
            padding: 0.5rem; /* Padding dalam input file */
            background-color: white; /* Warna latar belakang input file */
            font-family: 'Gilroy Light', sans-serif; /* Menggunakan font Gilroy ExtraBold untuk label */
            color: #A5A5A5; /* Warna "No file chosen" */
            transition: transform 0.2s; /* Efek transisi untuk timbul */
        }

        /* Gaya efek timbul untuk input file saat hover */
        input[type="file"]:hover {
            transform: translateY(-2px); /* Efek timbul saat hover */
        }

        /* Gaya untuk label dengan Gilroy ExtraBold */
        .label-custom {
            font-family: 'Gilroy ExtraBold', sans-serif; /* Font Gilroy ExtraBold */
            color: #295F98; /* Warna #295F98 */
        }

        /* Gaya untuk tombol dengan efek timbul */
        .btn-gradient {
            background: linear-gradient(to right, #00008B, #3B3BBD); /* Gradasi warna */
            border: none; /* Menghilangkan border */
            color: white; /* Warna tulisan */
            padding: 10px 20px; /* Padding tombol */
            border-radius: 0.375rem; /* Border radius untuk sudut */
            font-family: 'Gilroy ExtraBold', sans-serif; /* Menggunakan font Gilroy ExtraBold */
            transition: transform 0.2s; /* Efek transisi untuk timbul */
        }
        ...
        input[type="file"]::placeholder {
            font-family: 'Gilroy Light', sans-serif; /* Menggunakan font Gilroy Light untuk "No file chosen" */
            color: #A5A5A5; /* Warna "No file chosen" */
        }
    </style>
</head>
<body class="bg-white flex">
    ...
    <div class="flex-1 p-5 flex flex-col">
            ...
            <div class="grid grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="block text-sm text-gray-900 cursor-pointer bg-gray-50 focus:outline-none" id="scan_ktp" type="file">
                    </div>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <input class="block text-sm text-gray-900 cursor-pointer bg-gray-50 focus:outline-none" id="scan_ktm" type="file">
                    </div>
        ...
        <div class="flex justify-between mt-4">
            ...
            <button type="button" class="btn-gradient text-white py-2 px-4 rounded-lg shadow-lg">Send</button>
        </div>
    </div>
</body>
</html>
