...
class BerkasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($request, $pengajuanData) {
            ...
            $berkas->scan_ktp = $request->file('scan_ktp')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_scan_ktp.pdf') ? 'Pengaju_' . $pengajuan->id . '_scan_ktp.pdf' : 'data gagal terupload';
            $berkas->surat_sehat = $request->file('surat_sehat')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_surat_sehat.pdf') ? 'Pengaju_' . $pengajuan->id . '_surat_sehat.pdf' : 'data gagal terupload';
            $berkas->surat_rekomendasi_jurusan = $request->file('surat_rekomendasi_jurusan')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_surat_rekomendasi_jurusan.pdf') ? 'Pengaju_' . $pengajuan->id . '_surat_rekomendasi_jurusan.pdf' : 'data gagal terupload';
            $berkas->transkip_rekomendasi_jurusan = $request->file('transkip_rekomendasi_jurusan')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_transkip_rekomendasi_jurusan.pdf') ? 'Pengaju_' . $pengajuan->id . '_transkip_rekomendasi_jurusan.pdf' : 'data gagal terupload';
            $berkas->sertifikat_lkmm = $request->file('sertifikat_lkmm')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_lkmm.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_lkmm.pdf' : 'data gagal terupload';
            $berkas->sertifikat_pelatihan_kepemimpinan = $request->file('sertifikat_pelatihan_kepemimpinan')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_pelatihan_kepemimpinan.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_pelatihan_kepemimpinan.pdf' : 'data gagal terupload';
            // $berkas->sertifikat_pelatihan_emosional_spiritual = $request->file('sertifikat_pelatihan_emosional_spiritual')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_pelatihan_emosional_spiritual.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_pelatihan_emosional_spiritual.pdf' : $berkas->sertifikat_pelatihan_emosional_spiritual = null;
            if ($request->hasFile('sertifikat_pelatihan_emosional_spiritual')) {
                $berkas->sertifikat_pelatihan_emosional_spiritual = $request->file('sertifikat_pelatihan_emosional_spiritual')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_pelatihan_emosional_spiritual.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_pelatihan_emosional_spiritual.pdf' : 'data gagal terupload';
            } else {
                $berkas->sertifikat_pelatihan_emosional_spiritual = 'pengaju tidak mengirimkan file ini';
            }
            $berkas->sertifikat_bahasa_asing = $request->file('sertifikat_bahasa_asing')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_bahasa_asing.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_bahasa_asing.pdf' : 'data gagal terupload';
            $berkas->scan_ktm = $request->file('scan_ktm')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_scan_ktm.pdf') ? 'Pengaju_' . $pengajuan->id . '_scan_ktm.pdf' : 'data gagal terupload';
            $berkas->surat_keterangan_berkelakuan_baik = $request->file('surat_keterangan_berkelakuan_baik')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_surat_keterangan_berkelakuan_baik.pdf') ? 'Pengaju_' . $pengajuan->id . '_surat_keterangan_berkelakuan_baik.pdf' : 'data gagal terupload';
            $berkas->surat_penyataan_mandiri = $request->file('surat_penyataan_mandiri')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_surat_penyataan_mandiri.pdf') ? 'Pengaju_' . $pengajuan->id . '_surat_penyataan_mandiri.pdf' : 'data gagal terupload';
            $berkas->sertifikat_pkkmb = $request->file('sertifikat_pkkmb')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_pkkmb.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_pkkmb.pdf' : 'data gagal terupload';
            $berkas->sertifikat_bela_negara = $request->file('sertifikat_bela_negara')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_bela_negara.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_bela_negara.pdf' : 'data gagal terupload';
            // $berkas->sertifikat_agent_of_change = $request->file('sertifikat_agent_of_change')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_agent_of_change.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_agent_of_change.pdf' : 'data gagal terupload';
            if ($request->hasFile('sertifikat_agent_of_change')) {
                $berkas->sertifikat_agent_of_change = $request->file('sertifikat_agent_of_change')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_agent_of_change.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_agent_of_change.pdf' : 'data gagal terupload';
            } else {
                $berkas->sertifikat_agent_of_change = 'pengaju tidak mengirimkan file ini';
            }
            $berkas->sertifikat_berorganisasi = $request->file('sertifikat_berorganisasi')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_sertifikat_berorganisasi.pdf') ? 'Pengaju_' . $pengajuan->id . '_sertifikat_berorganisasi.pdf' : 'data gagal terupload';
            $berkas->berita_acara_pemilihan = $request->file('berita_acara_pemilihan')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_berita_acara_pemilihan.pdf') ? 'Pengaju_' . $pengajuan->id . '_berita_acara_pemilihan.pdf' : 'data gagal terupload';
            if ($request->hasFile('surat_pernyataan')) {
                $berkas->surat_pernyataan = $request->file('surat_pernyataan')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_surat_pernyataan.pdf') ? 'Pengaju_' . $pengajuan->id . '_surat_pernyataan.pdf' : 'data gagal terupload';
            } else {
                $berkas->surat_pernyataan = 'pengaju belum mengirimkan file ini';
            }
            if ($request->hasFile('surat_perjanjian')) {
                $berkas->surat_perjanjian = $request->file('surat_perjanjian')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_surat_perjanjian.pdf') ? 'Pengaju_' . $pengajuan->id . '_surat_perjanjian.pdf' : 'data gagal terupload';
            } else {
                $berkas->surat_perjanjian = 'pengaju belum mengirimkan file ini';
            }
            if ($request->hasFile('surat_mou')) {
                $berkas->surat_mou = $request->file('surat_mou')->storeas($folderPath, 'Pengaju_' . $pengajuan->id . '_surat_mou.pdf') ? 'Pengaju_' . $pengajuan->id . '_surat_mou.pdf' : 'data gagal terupload';
            } else {
